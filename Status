...
enum Status: int
{
     ...
     * That is, the client must authenticate it Status to get the requested response.
     *
     ...
     * In an API, this can also mean that the endpoint is valid but the resource it Status does not exist.
    ...
    public function text(): string
    {
        return match($this) {
            ...
            Status::REQUEST_TIMEOUT => 'Request Time-out',
            ...
            Status::RANGE_UNSATISFIABLE => 'Requested range unsatisfiable',
            ...
            Status::GATEWAY_TIMEOUT => 'Gateway Time-out',
